          ...
          <div className="w-32 h-32 mx-auto mb-8 relative">
            <div
              className={`absolute inset-0 rounded-full ${
                isScanning ? "bg-blue-100 animate-ping" : "bg-blue-50"
              } transition-all duration-300`}
            ></div>
            <div
              className={`absolute inset-4 rounded-full ${
                isScanning ? "bg-blue-200 animate-pulse" : "bg-blue-100"
              } transition-all duration-300`}
            ></div>
            <div
              className={`absolute inset-8 rounded-full ${
                isScanning ? "bg-blue-300 animate-bounce" : "bg-blue-200"
                  ...
                  <div className="flex space-x-1">
                    <div
                      className={`w-1 bg-blue-600 rounded-full ${
                        isScanning ? "h-8 animate-pulse" : "h-6"
                      } transition-all duration-300`}
                    ></div>
                    <div
                      className={`w-1 bg-blue-600 rounded-full ${
                        isScanning ? "h-10 animate-pulse" : "h-8"
                      } transition-all duration-300`}
                      style={{ animationDelay: "0.2s" }}
                    ></div>
                    <div
                      className={`w-1 bg-blue-600 rounded-full ${
                        isScanning ? "h-12 animate-pulse" : "h-10"
                      } transition-all duration-300`}
