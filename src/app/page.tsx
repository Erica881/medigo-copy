...
export default function Home() {
  ...
  return (
    ...
    >
      {/* Blue Header Section */}
      <div
        className="text-white px-4 py-8 sm:px-6 sm:py-12 text-center"
        style={{
          background:
            "linear-gradient(to right, var(--primary-blue), var(--primary-blue-dark))",
        }}
      >
      ...
      <div className="px-4 py-8 sm:px-6 sm:py-12">
        ...
        <div className="flex flex-col items-center mb-12 sm:mb-16 relative">
          ...
          <p
            className={`mt-4 sm:mt-6 text-xl sm:text-2xl font-medium text-gray-700 transition-opacity duration-300 ${
          ...
          <div className="space-y-3 sm:space-y-4">
              ...
              <div className="flex items-start space-x-3 sm:space-x-4">
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-700 mt-1 text-sm sm:text-base">
                    Singapore General Hospital - Cardiology
                  </p>
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
              <div className="flex items-start space-x-3 sm:space-x-4">
                <div
                  className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center flex-shrink-0"
                  style={{ backgroundColor: "var(--secondary-cream)" }}
                >
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5"
            ...
            <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 sm:p-6">
              <div className="flex items-start space-x-3 sm:space-x-4">
                <div
                  className="w-8 h-8 sm:w-10 sm:h-10 rounded-full flex items-center justify-center flex-shrink-0"
                  style={{ backgroundColor: "var(--tertiary-pink-light)" }}
                >
                  <svg
                    className="w-4 h-4 sm:w-5 sm:h-5"
                    style={{ color: "var(--tertiary-pink-dark)" }}
                    fill="currentColor"
                    viewBox="0 0 20 20"
                  >
                    <path
                ...
                <div className="flex-1 min-w-0">
                  ...
                  <p className="text-gray-700 mt-1 text-sm sm:text-base">
                    Chest pain evaluation completed
                  </p>
                  <p className="text-gray-500 text-xs sm:text-sm mt-1">
                    1 week ago
                  </p>
